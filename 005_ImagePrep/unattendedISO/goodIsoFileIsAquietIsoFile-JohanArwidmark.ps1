#This script comes from https://www.deploymentresearch.com/a-good-iso-file-is-a-quiet-iso-file/
# Seems that here there is something similar: https://dansonnenburg.wordpress.com/2021/11/04/press-any-key-to-continue-boot-image-feature/
<#
.Synopsis
