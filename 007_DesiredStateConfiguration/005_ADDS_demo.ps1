...
#$dscConfigLocalhostADDS_psm1_FileName      = 'New-ADDSC.psm1'
...
#$dscConfigLocalhostADDS_psm1_GithubUrl     = $dscConfigLocalhostADDS_GithubUrl,$dscConfigLocalhostADDS_psm1_FileName -join '/'
...
#C:\dsc\config\localhost\ActiveDirectory\New-ADDSC.psm1
#$dscConfigLocalhostADDS_psm1_FullPath      = Join-Path -Path $dscConfigLocalhostADDS_DirectoryPath -ChildPath $dscConfigLocalhostADDS_psm1_FileName
#endregion
...
#region 2.4. Self Signed CertificateCertificate - Thumbprint
...
#region 2.5. Install Missing Modules - TODO:
