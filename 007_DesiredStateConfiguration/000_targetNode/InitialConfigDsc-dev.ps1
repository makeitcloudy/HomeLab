...
function Set-InitialConfigurationDsc {
    ...
    BEGIN
    {
        ...
        try {
            ...
            Write-Output "$env:COMPUTERNAME - $($MyInvocation.MyCommand) - Retrieve the operating system information"
        ...
        $configData_psd1_fileName                  = 'ConfigData-dev.psd1'
        ...
        #C:\dsc\config\InitialSetup\ConfigData-dev.psd1
    ...
    PROCESS
    {
        ...
        #region - DSC - Certificate thumbprint update - ConfigData-dev.psd1
        try {
            # now modify the ConfigData-dev.psd1
        ...
        try {
            #$ConfigData = .\ConfigData-dev.psd1
