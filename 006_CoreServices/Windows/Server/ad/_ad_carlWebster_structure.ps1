...
#region - domain configuration - Enable Recycle Bin - page 449
Enable-ADOptionalFeature 'Recycle Bin Feature' -Scope ForestOrConfigurationSet -Target $DomainName -Confirm:$False
#endregion

#region - domain configuration -  Password and lockout policy
...
#region - domain configuration - Configure DNS
