...
**# Path to the Extracted or Mounted Windows ISO**<br>
$ISOMediaFolder = 'E:\'
**# Path to new re-mastered ISO**<br>
$ISOFile = 'C:\iso\Windows2016.iso'
**# Need to specify the root directory of the oscdimg.exe utility which you need to download**<br>
